...
<template>
    ...
    <section class="destination" id="destination">
        ...
        <div class="box-container">
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Miami </h3>
                    <p>Miami es una ciudad en el sureste de Florida, conocida por su clima tropical, playas impresionantes y
                        vida nocturna vibrante. Es un destino popular para aquellos que buscan diversión, compras y
                        relajación bajo el sol de Florida.</p>
                    <a href="/Miami" class>Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Londres</h3>
                    <p>La capital del Reino Unido, Londres, es una metrópolis diversa que combina la historia y la
                        modernidad. Ofrece una amplia gama de atracciones, desde el Palacio de Buckingham hasta el Museo
                        Británico</p>
                    <a href="/Londres">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $1.717.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>New York </h3>
                    <p>La Gran Manzana, Nueva York, es una de las ciudades más emblemáticas del mundo. Ofrece rascacielos
                        imponentes, teatros de Broadway y una escena artística vibrante.</p>
                    <a href="/New York">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $1.717.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Madrid </h3>
                    <p>Madrid, la capital de España, es conocida por su rica cultura, arte y vida nocturna. Puedes disfrutar
                        de tapas en los bares locales, visitar el Museo del Prado y explorar la arquitectura impresionante.
                    </p>
                    <a href="/Madrid">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $1.717.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Buenos Aires </h3>
                    <p> La ciudad de Buenos Aires en Argentina es famosa por su pasión por el tango, su deliciosa comida y
                        su arquitectura europea. Es una ciudad que combina un ambiente elegante con un toque de nostalgia.
                    </p>
                    <a href="/Buenos Aires">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $1.717.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Bogotá </h3>
                    <p>La capital de Colombia, Bogotá, es una ciudad cosmopolita con una rica historia y una creciente
                        escena de arte. El Museo del Oro y el centro histórico son puntos de referencia importantes.</p>
                    <a href="/Bogotá">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Medellín</h3>
                    <p>Conocida como "La Ciudad de la Eterna Primavera", Medellín es una de las ciudades más dinámicas de
                        Colombia. Rodeada por colinas verdes, la ciudad disfruta de un clima templado durante todo el año.
                        Medellín es famosa por su espíritu innovador.</p>
                    <a href="/Medellín">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $417.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Pereira</h3>
                    <p>Pereira es una ciudad colombiana rodeada de paisajes montañosos y cafetales. Es un destino ideal para
                        los amantes de la naturaleza y el café colombiano.</p>
                    <a href="/Pereira">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $417.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Cali</h3>
                    <p>Cali es famosa por ser la capital de la salsa en Colombia. La ciudad tiene una vibrante escena de
                        baile y música, además de una cultura culinaria única</p>
                    <a href="/Cali">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $417.176 </span> </h5>
                </div>
            </div>
            ...
            <div class="box" data-aos="fade-up" datas-aos-delay="150">
                ...
                <div class="content">
                    <h3>Cartagena</h3>
                    <p>Cartagena, en la costa caribeña de Colombia, es conocida por su encanto histórico, arquitectura
                        colonial y playas de aguas cristalinas. Es un lugar perfecto para sumergirse en la historia y la
                        cultura.</p>
                    <a href="/Cartagena">Ver vuelos <i class="material-symbols-outlined">arrow_forward_ios</i></a>
                    <h5>Desde <br> <span> $417.176 </span> </h5>
                </div>
            </div>
    ...
    <section class="about" id="about">
        ...
        <div class="content" data-aos="fade-left" datas-aos-delay="600">
            ...
            <p>Ofrecemos calidad y tarifas competitivas en tus boletos de avión. Nuestro compromiso con tu satisfacción es
                inquebrantable, y nuestra dedicación a hacer que tu viaje sea inolvidable te dejará deseando volver a volar
                con nosotros.</p>
        </div>
    </section>
    <!------------------------------------------------FOOTER------------------------------------------->
...
<style lang="scss" > @import url("https://fonts.googleapis.com/css2?family=Nunito:ital,wght@0,200;1,300&family=Poppins:ital,wght@0,100;0,300;0,400;0,500;0,600;1,200&display=swap");
            ...
            flightService.parametrizedSearch(this.searchParams)
                .then(response => {
                    if (response.status === 200) {
                        ...
                        const url = `/flights/${this.searchParams.origin}-${this.searchParams.destination}/${this.searchParams.departureDate}`;
                        
                        // Redirige a la nueva vista con la URL construida
